...
class AppTheme {
  ...
  static ThemeData dark() {
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        displayLarge: TextStyle(fontSize: 40, fontWeight: FontWeight.w700, inherit: true),
        displayMedium: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, inherit: true),
        displaySmall: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, inherit: true),
        headlineLarge: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, inherit: true),
        headlineMedium: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, inherit: true),
        headlineSmall: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, inherit: true),
        titleLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, inherit: true),
        ...
        bodyLarge: TextStyle(fontSize: 16, height: 1.45, inherit: true),
        bodyMedium: TextStyle(fontSize: 14, height: 1.45, inherit: true),
        bodySmall: TextStyle(fontSize: 12, height: 1.4, inherit: true),
        labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, inherit: true),
        labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, inherit: true),
